...
variable "aws_account_name" { default = "aws-govcloud" }
...
variable "aws_spoke_vpcs" {
  default = {
    aws_spoke1_vpc = {
      name = "AWS-UGW-Spoke1-VPC"
      cidr = "10.61.0.0/16"
    }
    aws_spoke2_vpc = {
      name = "AWS-UGW-Spoke2-VPC"
      cidr = "10.62.0.0/16"
    }
  }
}

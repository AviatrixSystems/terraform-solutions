...
data "local_file" "iam_policy_assume_role_govcloud" {
  filename = "/root/controller-govcloud/aviatrix-controller-iam-roles/iam_assume_role_policy_govcloud.txt"
}
...
resource aws_iam_policy aviatrix-assume-role-policy {
  ...
  policy      = data.local_file.iam_policy_assume_role_govcloud.content
}
